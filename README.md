# 🛡️ SonarQube Quality Gate Studio
> Configure automated static code quality analysis. Generate sonar-project.properties specifications, define directory exclusions, coverage minimum targets, and check gates.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/sonarqube/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/sonarqube/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-sonarqube.git
cd tp-sonarqube
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/sonarqube/) |
